...
PUBLIC CREATE_PLAN_FFTW, DESTROY_PLAN_FFTW, DESTROY_PLANS_FFTW, INIT_PLANS_FFTW, &
      & FFTW_RESOL, TW, EXEC_FFTW, EXEC_EFFTW, EXPORT_FFTW_WISDOM
...
IF (LUSE_MEASURE) THEN
  WRITE(NOUT,*) 'ecTrans is using MEASURE, and FFTW wisdom files'
ELSE
  WRITE(NOUT,*) 'ecTrans is *not* using MEASURE or FFTW wisdom files'
ENDIF
