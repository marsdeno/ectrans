...
#ifdef HAVE_RAVE
CALL RAVE_BEGIN_REGION('DIR_TRANS_CTL')
#endif
 ...
 & KVSETUV,KVSETSC)
  ...
  DO JBLK=1,IBLKS
    ...
    IF(IF_UV_G > 0 .AND. IF_SCALARS_G > 0) THEN
      #ifdef HAVE_RAVE
      CALL RAVE_BEGIN_REGION('FTDIR_CTL')
      #endif
      ...
      #ifdef HAVE_RAVE
      CALL RAVE_END_REGION('FTDIR_CTL')
      #endif
    ...
    ENDIF
    #ifdef HAVE_RAVE
    CALL RAVE_BEGIN_REGION('LTDIR_CTL')
    #endif
    ...
    #ifdef HAVE_RAVE
    CALL RAVE_END_REGION('LTDIR_CTL')
    #endif
...
#ifdef HAVE_RAVE
CALL RAVE_END_REGION('DIR_TRANS_CTL')
#endif
