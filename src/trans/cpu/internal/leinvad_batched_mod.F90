...
DO I = 1, NBATCH
  ...
  ELSE
    CALL C_F_POINTER(C_LOC(ZWORK_BA(IOFF_BA)), ZB_BUF, [KDGLU, KIFC])
    CALL C_F_POINTER(C_LOC(ZWORK_CA(IOFF_C)),  ZC_BUF, [ILA, KIFC])
    CALL MULT_BUTM('T', S%FA(KMLOC)%YBUT_STRUCT_A, KIFC, ZB_BUF, ZC_BUF)
  ENDIF
...
DO I = 1, NBATCH
  ...
  ELSE
    CALL C_F_POINTER(C_LOC(ZWORK_BS(IOFF_BS)), ZB_BUF, [KDGLU, KIFC])
    CALL C_F_POINTER(C_LOC(ZWORK_CS(IOFF_C)),  ZC_BUF, [ILS, KIFC])
    CALL MULT_BUTM('T', S%FA(KMLOC)%YBUT_STRUCT_S, KIFC, ZB_BUF, ZC_BUF)
  ENDIF
