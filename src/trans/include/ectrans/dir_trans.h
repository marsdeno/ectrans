...
!!LOGICAL, OPTIONAL, INTENT(IN) :: LDPSPVOR_ON_DEVICE
!!LOGICAL, OPTIONAL, INTENT(IN) :: LDPSPDIV_ON_DEVICE
!!LOGICAL, OPTIONAL, INTENT(IN) :: LDPSPSCALAR_ON_DEVICE
!!LOGICAL, OPTIONAL, INTENT(IN) :: LDPSPSC3A_ON_DEVICE
!!LOGICAL, OPTIONAL, INTENT(IN) :: LDPSPSC3B_ON_DEVICE
!!LOGICAL, OPTIONAL, INTENT(IN) :: LDPSPSC2_ON_DEVICE

!!LOGICAL, OPTIONAL, INTENT(IN) :: LDPGP_ON_DEVICE
!!LOGICAL, OPTIONAL, INTENT(IN) :: LDPGPUV_ON_DEVICE
!!LOGICAL, OPTIONAL, INTENT(IN) :: LDPGP3A_ON_DEVICE
!!LOGICAL, OPTIONAL, INTENT(IN) :: LDPGP3B_ON_DEVICE
!!LOGICAL, OPTIONAL, INTENT(IN) :: LDPGP2_ON_DEVICE
