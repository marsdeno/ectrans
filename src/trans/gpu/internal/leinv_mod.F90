...
#endif
#ifdef ACCGPU
!$ACC PARALLEL LOOP COLLAPSE(2) PRIVATE(KM,IA,J) FIRSTPRIVATE(KF_LT,TDZAA) DEFAULT(NONE)
#endif
DO KMLOC=1,D_NUMP
  DO JK=1,2*KF_LT
    KM =  D_MYMS(KMLOC)
...
#endif
#ifdef ACCGPU
!$ACC PARALLEL LOOP COLLAPSE(2) PRIVATE(KM,IS,J) FIRSTPRIVATE(KF_LT,TDZAS) DEFAULT(NONE)
#endif
DO KMLOC=1,D_NUMP
  DO JK=1,2*KF_LT
    KM =  D_MYMS(KMLOC)
...
#endif
#ifdef ACCGPU
!$ACC PARALLEL LOOP COLLAPSE(2) PRIVATE(KM,ISL,IGLS,ISTAS,ZAOA,ZSOA,OFFSET1,OFFSET2) FIRSTPRIVATE(KF_LT,R_NDGL) DEFAULT(NONE)
#endif
DO KMLOC=1,D_NUMP
  DO JK=1,2*KF_LT
    KM = D_MYMS(KMLOC)
