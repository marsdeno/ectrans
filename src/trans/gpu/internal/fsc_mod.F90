...
#endif
#ifdef ACCGPU
  !$ACC PARALLEL LOOP COLLAPSE(2) DEFAULT(NONE) ASYNC(1) PRIVATE(IGLG,IOFF,ZACHTE2) FIRSTPRIVATE(IBEG,IEND,IINC,OFFSET_VAR)
#endif
...
#endif
#ifdef ACCGPU
  !$ACC PARALLEL LOOP COLLAPSE(2) DEFAULT(NONE) FIRSTPRIVATE(IBEG,IEND,IINC,OFFSET_VAR) PRIVATE(IGLG,IOFF,ZACHTE2) ASYNC(1)
#endif
  DO KGL=IBEG,IEND,IINC
...
#ifdef OMPGPU
  !$OMP TARGET TEAMS DISTRIBUTE PARALLEL DO DEFAULT(NONE) SHARED(ISTAGTF,IMEN,KF_UV,PUVDERS,ZACHTE2,PUV)
#endif
#ifdef ACCGPU
!$ACC PARALLEL LOOP COLLAPSE(2) DEFAULT(NONE) FIRSTPRIVATE(IBEG,IEND,IINC,OFFSET_VAR) PRIVATE(IGLG,IOFF,ZACHTE2,JF_UV) ASYNC(1)
#endif
  DO KGL=IBEG,IEND,IINC
...
#ifdef OMPGPU
  !$OMP TARGET TEAMS DISTRIBUTE PARALLEL DO DEFAULT(NONE) SHARED(ISTAGTF,IMEN,KF_SCALARS,PEWDERS,ZACHTE2,PSCALAR)
#endif
#ifdef ACCGPU
  !$ACC PARALLEL LOOP COLLAPSE(2) DEFAULT(NONE) FIRSTPRIVATE(IBEG,IEND,IINC,OFFSET_VAR) PRIVATE(IGLG,IOFF,ZACHTE2,JF_SCALAR) ASYNC(1)
#endif
  DO KGL=IBEG,IEND,IINC
