...
#endif
#ifdef ACCGPU
   !$ACC PARALLEL LOOP COLLAPSE(3) DEFAULT(NONE) PRIVATE(KM,ILCM,IFLD,IASM0,IR,II,INM) FIRSTPRIVATE(KFIELDS)
#endif
   DO KMLOC=1,D_NUMP
      DO JN=1,R_NSMAX+1
         DO JFLD=1,KFIELDS
...
#endif
#ifdef ACCGPU
   !$ACC PARALLEL LOOP DEFAULT(NONE) COLLAPSE(2) PRIVATE(KM,ILCM) FIRSTPRIVATE(KFIELDS)
#endif
   DO KMLOC=1,D_NUMP
      DO JFLD=1,2*KFIELDS
         KM = D_MYMS(KMLOC) 
...
#endif
#ifdef ACCGPU
   !$ACC PARALLEL LOOP DEFAULT(NONE) COLLAPSE(2) PRIVATE(KM,IASM0,INM,JN) FIRSTPRIVATE(KFIELDS,KDIM)
#endif
  DO KMLOC=1,D_NUMP
    DO JFLD=1,KFIELDS
      KM = D_MYMS(KMLOC)
...
#endif
#ifdef ACCGPU
   !$ACC PARALLEL LOOP DEFAULT(NONE) COLLAPSE(2) PRIVATE(KM,JN) FIRSTPRIVATE(KFIELDS)
#endif
  DO KMLOC=1,D_NUMP
    DO JFLD=1,2*KFIELDS
      PIA(JFLD,1,KMLOC) = 0.0_JPRB
